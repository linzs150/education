...
import uikit.common.adapter.BaseAdapter;
import uikit.common.adapter.BaseDelegate;
import uikit.common.adapter.BaseViewHolder;
import uikit.common.adapter.ItemClickListerAdapter;
import uikit.common.media.imagepicker.Constants;
import uikit.common.media.imagepicker.ImagePicker;
import uikit.common.media.imagepicker.view.SuperCheckBox;
...
public class ImagePreviewActivity extends ImagePreviewBaseActivity implements ImagePicker.OnImageSelectedListener,
    ...
    private void updateCheckState() {
        ...
        if (selectOrder > 0) {
            int pos = 0;
            for (uikit.common.media.model.GLImage GLImage : imagePicker.getSelectedImages()) {
