package uikit.common.media.imagepicker;
...
import uikit.common.media.imagepicker.option.DefaultImagePickerOption;
import uikit.common.media.imagepicker.option.ImagePickerOption;
import uikit.common.media.imagepicker.ui.ImageGridActivity;
import uikit.common.media.imagepicker.ui.ImagePreviewActivity;
import uikit.common.media.imagepicker.ui.ImageTakeActivity;
...
public class ImagePickerLauncher {
    ...
    public static void pickImage(final Activity context, final int requestCode, int titleResId) {
        ...
        dialog.addItem(context.getString(R.string.input_panel_video), () -> takePhoto(context, requestCode));
