...
import uikit.common.media.imagepicker.loader.ImageLoader;
...
import uikit.common.media.imagepicker.view.CropImageView;
...
public class ImagePicker {
    ...
    public int selectOrder(GLImage item) {
        int i = 1;
        for (uikit.common.media.model.GLImage GLImage : mSelectedImages) {
