...
import uikit.common.media.imagepicker.adapter.ImagePageAdapter;
import uikit.common.media.imagepicker.adapter.LocalImagePageAdapter;
import uikit.common.media.imagepicker.view.ViewPagerFixed;
...
public class ImagePreviewRetakeActivity extends ImageBaseActivity implements View.OnClickListener {
    ...
    public static void start(Activity activity, GLImage GLImage) {
        List<uikit.common.media.model.GLImage> GLImages = new ArrayList<>(1);
