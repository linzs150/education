package uikit.business.session.viewholder.robot;
...
import uikit.business.robot.model.RobotBotContent;
import uikit.business.robot.model.RobotResponseContent;
import uikit.business.robot.parser.elements.base.Element;
...
import uikit.business.robot.parser.elements.group.TemplateRoot;
...
public class RobotContentLinearLayout extends LinearLayout {
    ...
    private void convertTemplateToViews(final TemplateRoot template, final ClickableChildView robot) {
        List<uikit.business.robot.parser.elements.group.LinearLayout> robotLinearLayouts = template.getElements();
        if (robotLinearLayouts == null) {
            return;
        }
        for (uikit.business.robot.parser.elements.group.LinearLayout robotLinearLayout : robotLinearLayouts) {
