package uikit.business.session.helper;
...
import uikit.business.session.activity.CaptureVideoActivity;
import uikit.common.ToastHelper;
import uikit.common.ui.dialog.CustomAlertDialog;
import uikit.common.util.C;
import uikit.common.util.file.AttachmentStore;
...
public class VideoMessageHelper {
    ...
    public void showVideoSource(int local, int capture) {
        ...
        dialog.addItem(activity.getString(R.string.take_video), new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
                chooseVideoFromCamera();
            }
        });
        dialog.addItem(activity.getString(R.string.select_video_album), new CustomAlertDialog.onSeparateItemClickListener() {
            @Override
            public void onClick() {
