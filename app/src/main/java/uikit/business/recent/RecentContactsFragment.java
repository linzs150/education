...
import uikit.api.model.main.OnlineStateChangeObserver;
import uikit.api.model.team.TeamDataChangedObserver;
import uikit.api.model.team.TeamMemberDataChangedObserver;
import uikit.api.model.user.UserInfoObserver;
import uikit.business.recent.adapter.RecentContactAdapter;
import uikit.business.uinfo.UserInfoHelper;
import uikit.common.ToastHelper;
import uikit.common.badger.Badger;
...
import uikit.common.ui.drop.DropManager;
import uikit.common.ui.recyclerview.listener.SimpleClickListener;
        ...
        callback = new RecentContactsCallback() {
            ...
            public void onItemClick(RecentContact recent) {
                if (recent.getSessionType() == SessionTypeEnum.SUPER_TEAM) {
                    ToastHelper.showToast(mCtx, mCtx.getString(R.string.super_team_impl_by_self));
                } else if (recent.getSessionType() == SessionTypeEnum.Team) {
                    NimUIKit.startTeamSession(mCtx, recent.getContactId());
                } else if (recent.getSessionType() == SessionTypeEnum.P2P) {
                    NimUIKit.startP2PSession(mCtx, recent.getContactId());
                }
            }
...
//            showLongClickMenu(adapter.getItem(position), position);
    ...
    private void showLongClickMenu(final RecentContact recent, final int position) {
        ...
        CustomAlertDialog alertDialog = new CustomAlertDialog(mCtx);
        ...
        alertDialog.addItem(itemText, () -> NIMClient.getService(MsgService.class)
                ...
                .setCallback(new RequestCallback<Void>() {
                    ...
                    public void onSuccess(Void param) {
                        ToastHelper.showToast(mCtx, "delete success");
                    }

                    @Override
                    public void onFailed(int code) {
                        ToastHelper.showToast(mCtx,
