package com.one.education.widget.smartrefresh.layout.impl;
...
import com.one.education.widget.smartrefresh.layout.listener.CoordinatorLayoutListener;
import com.one.education.widget.smartrefresh.layout.util.DesignUtil;
...
import static com.one.education.widget.smartrefresh.layout.util.ScrollBoundaryUtil.canScrollDown;
import static com.one.education.widget.smartrefresh.layout.util.ScrollBoundaryUtil.canScrollUp;
import static com.one.education.widget.smartrefresh.layout.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
import static com.one.education.widget.smartrefresh.layout.util.SmartUtil.isContentView;
import static com.one.education.widget.smartrefresh.layout.util.SmartUtil.measureViewHeight;
import static com.one.education.widget.smartrefresh.layout.util.SmartUtil.scrollListBy;
