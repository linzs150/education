...
public class CircleRectangleImageView extends AppCompatImageView {
    ...
    public CircleRectangleImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleRectangleImageView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);

        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CircleRectangleImageView, defStyle, 0);
        // 获取类型
        type = a.getInt(R.styleable.CircleRectangleImageView_type, TYPE_CIRCLE);
        // 获取圆角半径
        mRoundRadius = a.getDimensionPixelSize(R.styleable.CircleRectangleImageView_round_Radius, DEFAULT_ROUND_RADIUS);
        // 获取边界的宽度
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleRectangleImageView_border_width, DEFAULT_BORDER_WIDTH);
        // 获取边缘的颜色
        mBorderColor = a.getColor(R.styleable.CircleRectangleImageView_border_color, DEFAULT_BORDER_COLOR);
