...
import com.newtonacademic.newtontutors.activities.StudentsImproveInformation;
import com.newtonacademic.newtontutors.api.SystemInterface;
import com.newtonacademic.newtontutors.beans.SmsCodeInfo;
...
import com.newtonacademic.newtontutors.login.SelectCountryCodeActivity;
    ...
    private View.OnClickListener mOnClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.back_btn) {
                ...
                if (mType == 0) {
                    addJob(NetmonitorManager.sendSmsCode(finalPhone, new RestNewCallBack<com.newtonacademic.newtontutors.beans.SmsCodeInfo>() {
                        @Override
                        public void success(com.newtonacademic.newtontutors.beans.SmsCodeInfo smsCodeInfo) {
                            closeProgress();
                            if (smsCodeInfo != null) {
                    ...
                    addJob(NetmonitorManager.sendEmailCode(finalPhone, new RestNewCallBack<com.newtonacademic.newtontutors.beans.SmsCodeInfo>() {
                        @Override
                        public void success(com.newtonacademic.newtontutors.beans.SmsCodeInfo smsCodeInfo) {
                            closeProgress();
                            if (smsCodeInfo != null) {
...
//                    });
                    ...
                    com.newtonacademic.newtontutors.commons.ToastUtils.showToastShort(getString(R.string.accept_the_terms));
                }
