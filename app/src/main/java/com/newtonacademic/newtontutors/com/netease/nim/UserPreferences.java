package com.newtonacademic.newtontutors.com.netease.nim;
...
public class UserPreferences {
    ...
    static SharedPreferences getSharedPreferences() {
        return DemoCache.getContext().getSharedPreferences("Education." + DemoCache.getAccount(), Context.MODE_PRIVATE);
    }
}
