...
public class NewTimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    private NewTimePickerView.OnTimeSelectListener timeSelectListener;//回调接口
    ...
    //构造方法
    public NewTimePickerView(NewTimePickerView.Builder builder) {
    ...
    public static class Builder {
        ...
        private NewTimePickerView.OnTimeSelectListener timeSelectListener;
        ...
        //Required
        public Builder(Context context, NewTimePickerView.OnTimeSelectListener listener) {
            this.context = context;
            this.timeSelectListener = listener;
        }

        //Option
        public NewTimePickerView.Builder setType(boolean[] type) {
            this.type = type;
            return this;
        }

        public NewTimePickerView.Builder gravity(int gravity) {
            this.gravity = gravity;
            return this;
        }

        public NewTimePickerView.Builder setSubmitText(String Str_Submit) {
            this.Str_Submit = Str_Submit;
            return this;
        }

        public NewTimePickerView.Builder isDialog(boolean isDialog) {
            this.isDialog = isDialog;
            return this;
        }

        public NewTimePickerView.Builder setCancelText(String Str_Cancel) {
            this.Str_Cancel = Str_Cancel;
            return this;
        }

        public NewTimePickerView.Builder setTitleText(String Str_Title) {
            this.Str_Title = Str_Title;
            return this;
        }

        public NewTimePickerView.Builder setSubmitColor(int Color_Submit) {
            this.Color_Submit = Color_Submit;
            return this;
        }

        public NewTimePickerView.Builder setCancelColor(int Color_Cancel) {
         ...
         * @return
         */
        public NewTimePickerView.Builder setDecorView(ViewGroup decorView) {
            this.decorView = decorView;
            return this;
        }

        public NewTimePickerView.Builder setBgColor(int Color_Background_Wheel) {
            this.Color_Background_Wheel = Color_Background_Wheel;
            return this;
        }

        public NewTimePickerView.Builder setTitleBgColor(int Color_Background_Title) {
            this.Color_Background_Title = Color_Background_Title;
            return this;
        }

        public NewTimePickerView.Builder setTitleColor(int Color_Title) {
            this.Color_Title = Color_Title;
            return this;
        }

        public NewTimePickerView.Builder setSubCalSize(int Size_Submit_Cancel) {
            this.Size_Submit_Cancel = Size_Submit_Cancel;
            return this;
        }

        public NewTimePickerView.Builder setTitleSize(int Size_Title) {
            this.Size_Title = Size_Title;
            return this;
        }

        public NewTimePickerView.Builder setContentSize(int Size_Content) {
         ...
         * @return
         */
        public NewTimePickerView.Builder setDate(Calendar date) {
            this.date = date;
            return this;
        }

        public NewTimePickerView.Builder setLayoutRes(int res, CustomListener customListener) {
            this.layoutRes = res;
            this.customListener = customListener;
            return this;
        }

        public NewTimePickerView.Builder setRange(int startYear, int endYear) {
        ...
        public NewTimePickerView.Builder setRangDate(Calendar startDate, Calendar endDate) {
         ...
         */
        public NewTimePickerView.Builder setLineSpacingMultiplier(float lineSpacingMultiplier) {
         ...
         * @param dividerColor
         */
        public NewTimePickerView.Builder setDividerColor(int dividerColor) {
         ...
         * @param dividerType
         */
        public NewTimePickerView.Builder setDividerType(WheelView.DividerType dividerType) {
        ...
        public NewTimePickerView.Builder setBackgroundId(int backgroundId) {
         ...
         */
        public NewTimePickerView.Builder setTextColorCenter(int textColorCenter) {
         ...
         * @param textColorOut
         */
        public NewTimePickerView.Builder setTextColorOut(int textColorOut) {
            this.textColorOut = textColorOut;
            return this;
        }

        public NewTimePickerView.Builder isCyclic(boolean cyclic) {
            this.cyclic = cyclic;
            return this;
        }

        public NewTimePickerView.Builder setOutSideCancelable(boolean cancelable) {
            this.cancelable = cancelable;
            return this;
        }

        public NewTimePickerView.Builder setLunarCalendar(boolean lunarCalendar) {
            isLunarCalendar = lunarCalendar;
            return this;
        }

        public NewTimePickerView.Builder setLabel(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
         ...
         * @return
         */
        public NewTimePickerView.Builder setTextXOffset(int xoffset_year, int xoffset_month, int xoffset_day, int xoffset_hours, int xoffset_mins, int xoffset_seconds) {
        ...
        public NewTimePickerView.Builder isCenterLabel(boolean isCenterLabel) {
