package com.newtonacademic.newtontutors.widget.smartrefresh.layout.footer;
...
import com.newtonacademic.newtontutors.widget.smartrefresh.layout.internal.ArrowDrawable;
import com.newtonacademic.newtontutors.widget.smartrefresh.layout.internal.InternalClassics;
import com.newtonacademic.newtontutors.widget.smartrefresh.layout.internal.ProgressDrawable;
...
public class ClassicsFooter extends InternalClassics<ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (REFRESH_FOOTER_PULLING == null) {
            REFRESH_FOOTER_PULLING = mCtx.getString(R.string.srl_footer_pulling);
        }

        if (REFRESH_FOOTER_RELEASE == null) {
            REFRESH_FOOTER_RELEASE = mCtx.getString(R.string.srl_footer_release);
        }

        if (REFRESH_FOOTER_LOADING == null) {
            REFRESH_FOOTER_LOADING = mCtx.getString(R.string.srl_footer_loading);
        }

        if (REFRESH_FOOTER_REFRESHING == null) {
            REFRESH_FOOTER_REFRESHING = mCtx.getString(R.string.srl_footer_refreshing);
        }

        if (REFRESH_FOOTER_FINISH == null) {
            REFRESH_FOOTER_FINISH = mCtx.getString(R.string.srl_footer_finish);
        }

        if (REFRESH_FOOTER_FAILED == null) {
            REFRESH_FOOTER_FAILED = mCtx.getString(R.string.srl_footer_failed);
        }

        if (REFRESH_FOOTER_NOTHING == null) {
            REFRESH_FOOTER_NOTHING = mCtx.getString(R.string.srl_footer_nothing);
        }
        ...
        TypedArray ta = mCtx.obtainStyledAttributes(attrs, R.styleable.ClassicsFooter);
